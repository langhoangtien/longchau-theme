const UserDuoton = ({ className }: { className?: string }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
  ...
  >
    ...
    <defs>
      ...
      >
        <stop stopColor="hsl(var(--primary-dark))"></stop>
        <stop offset="1" stopColor="hsl(var(--primary-darker))"></stop>
      </linearGradient>
    </defs>
  </svg>
);
export default UserDuoton;
